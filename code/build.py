...
if platform.system()=="Linux":
    ...
    ARGUMENTS = "-D MAC -arch arm64"  # -D is a #define sent to the preprocessor.
    INCLUDE_DIR = "-I ./include/ -I./../common/thirdparty/old/glm"
    LIBRARIES = "-F/Library/Frameworks -framework OpenGL -lGLEW -lSDL2_image -lSDL2"
    ...
    LIBRARIES="-lmingw32 -lSDL2main -lSDL2_image -lSDL2 -lglew32 -lOpenGL32"
# (2)=================== Platform specific configuration ===================== #
